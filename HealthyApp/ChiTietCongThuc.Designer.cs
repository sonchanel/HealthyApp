namespace HealthyApp
{
	partial class ChiTietCongThuc
	{
		...
		private void InitializeComponent()
		{
			...
			// panelChitiet
			// 
			panelChitiet.Controls.Add(textBoxTimKiem);
			...
			dataGridNguyenLieu.Location = new Point(7, 72);
			...
			dataGridNguyenLieu.Size = new Size(240, 131);
